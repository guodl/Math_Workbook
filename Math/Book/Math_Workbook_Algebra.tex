...
\begin{tasks}[label=(\alph*), after-item-skip=2pt,after-skip=3pt, label-width=4ex](2)
    ...
    \task  $ \frac{3}{2(x+7)}-\frac{x+8}{x^2-49}    $   \\   
             % \begin{envWorkedSolL} [0.5\textwidth]{ $   =\frac{3}{2(x+7)}-\frac{x+8}{(x+7)(x-7)}                          $ }\end{envWorkedSolL}    \\
             % \begin{envWorkedSolL} [0.5\textwidth]{ $   = \frac{3(x-7)}{2(x+7)(x-7)}-\frac{2(x+8)}{2(x+7)(x-7)}           $ }\end{envWorkedSolL}    \\
