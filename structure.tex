...
%\fancyfoot[LO]{\textsuperscript{\textcopyright}2021 Elite Tuition Limited} % Print the nearest section name on the left side of odd pages
%\fancyfoot[RE]{\textsuperscript{\textcopyright}2021 Elite Tuition Limited} % Print the current chapter name on the right side of even pages
...
\iftoggle{biPublish}{
       \fancyfoot[L]{\href{http://www.eliteducation.net}{\textsuperscript{\textcopyright}Elite Tuition 2021}}
...
\iftoggle{biTutorCN}{
       \fancyfoot[LE]{\href{http://www.eliteducation.net}{\textsuperscript{\textcopyright} 
                                          \begin{CJK*}{UTF8}{gbsn}精英补习　私塾辅导\end{CJK*}  }}
...
\renewcommand{\cmdPaperCIE}[3]
{
    ...
    \ifboolexpr{(not togl{bQuestion}) and togl {bSolution}}{ 
        \IfFileExists{../../Education/ExamPaper/Cambridge/#1_#2_qp_#3_Solution.pdf}{
            \includepdf[pages=1- , frame, scale=0.9, pagecommand={},
                        addtotoc={1, subsection, 1, #1\_#2\_qp\_#3, lable,
...
{    
    \iftoggle{bQuestion} {
        ...
        \iftoggle{bSolution}{ 
            \IfFileExists{../../Education/ExamPaper/HSC/#1-#2-Solution.pdf}{
                \includepdf[pages=1- , frame, scale=0.9, pagecommand={},
                        addtotoc={1, subsubsection, 1, Worked Solution, lable}]
...
\newcommand{\udensdot}[2][\textwidth]{%
	...
	{
		\tikz[baseline=(todotted.base)]{
			\node[inner sep=1pt,outer sep=0pt] (todotted) {\phantom{#2}};
			%\draw[densely dotted] (todotted.south west) -- (todotted.south east);
			%\draw[densely dotted] (todotted.south west) -- +(0:4cm);
			\draw[densely dotted] (todotted.south west) -- +(0:#1);
		}%
